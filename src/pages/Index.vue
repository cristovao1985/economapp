<template>
  <q-page class="q-ma-md">
    ...
    <q-list>
      <q-item clickable v-ripple to="produtos" class="q-pa-lg bg-grey-3 q-mb-sm">
        <q-item-section> Quero economizar pesquisando produtos</q-item-section>
        <q-item-section avatar>
          <q-icon color="primary" name="arrow_forward_ios" />
        </q-item-section>
      </q-item>
      <q-item clickable v-ripple to="nfe" class="q-pa-lg bg-grey-3">
